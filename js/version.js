...
(function (G) {
  ...
  G.CHANGELOG = [
    {
      v: '5.4', name: 'Level Crossing', items: [
        ['🏎', 'Two new cars', 'The Regent V12 is a long-bonnet grand tourer: the highest top speed in the paddock and dead steady flat out, but 1.6 tonnes arriving at every hairpin, and no use on dirt. It owns the fast tracks. The Rotor 7 is a light rotary coupé that revs to 9,000 and makes almost nothing below half of that: keep it spinning and it flies through flowing corners, drop it off the boil and it bogs. Both have their own engine note - a silky V12 scream and the rotary’s buzz, with a lumpy “brap” at idle - and both are premium cars you buy in a session.'],
        ['🗺', 'Three new tracks', 'Frostbite Lake: a winter circuit with a causeway straight across a frozen lake - 280 m of sheet ice with a kink in it and the wind coming off the water, tarmac everywhere else. Freight Yard: a dusk circuit that crosses the main line twice, and the trains run to a timetable. Ashfall Ridge: flat out down a live volcano, with a crosswind on the crater rim, two long runs on loose ash and lava bombs raining into the road.'],
        ['🚂', 'Level crossings', 'A train of nine wagons crosses the road on its own timetable. The lights flash as it comes, the barriers are open at the rails, and the HUD calls it from 170 m out because at chase-camera height you would see the lights too late. Beat it across or wait: it does not stop, and the side of a moving train is exactly as solid as it looks. The bots wait for it too.'],
        ['⛰', 'Serpent Pass fights back', 'Its rockfall gorge only ever held ONE rock at a time over 150 m, and it was the only rockfall on a point-to-point run - so you met it once, near the start, and that was it. The gorge now runs four streams of rocks, and two more rockfall zones come down on the descent, so the mountain keeps throwing things at you all the way to the finish. Bigger dust clouds when they land, too.'],
        ['🎨', 'A paint shop that makes sense, and new things in it', 'The Paint tab was fourteen sections in one long scroll, with the colour, its finish and the accent three screens apart and the whole Sound section in the middle. It is now four tabs - Paint, Body, Wheels and Sound - with your current choice beside every heading, and the camera drops low and close when you pick the Wheels tab. Dragging the car round no longer highlights every word it passes over. New in it: Heritage band, Contrast panels and Retro pinstripe liveries, Split 5 and Classic 8 wheels, and a Pearl finish.'],
        ['🔊', 'Every car sounds like yours', 'Other cars ran on a much cheaper voice than your own - three oscillators and a filter - and at 20 m played at about a sixth of your engine’s level. They now get the same recipe as yours: the combustion grit that makes an engine sound like an engine, their gearchanges and limiter, the supercharger’s full whine and the turbo’s whoosh, and you hear the nearest five from 150 m. And a supercharger’s whine is about 1.7 times louder, on your car and theirs.'],
        ['🔧', 'The next track in the garage', 'The layout of the next race is shown in the garage now, beside NEXT RACE, where you can still build and tune for it. On the start line it was too late to do anything about.'],
        ['🚦', 'Ten seconds on the grid', 'The countdown runs from ten instead of three, with the five start lights coming on one a second over the last five and all going out for the go. Enough time to see the start coming, pick your line into the first corner and rev the engine through it.'],
        ['⚖', 'The V8 wins the drag again, and the Volt stops winning everything', 'A wing made the same downforce in newtons on every car, so on a 960 kg roadster it was half again the grip it was on a 1,440 kg muscle car: the Full Aero Kit made the Sting S 8% faster and the Mule V8 2%, and a fully built Sting won more tracks than anything in the paddock. Aero is now sized to the car it is bolted to, so downforce per kilo comes out close to even. The Mule also had only 6% more power per kilo than the four-cylinder; it now has 190 kW and wins a quarter mile by three tenths. The Volt E was winning six tracks of seventeen whether stock or fully built, because a cooling upgrade cancelled the one thing meant to hold it back - its motor running hot on long runs. Cooling parts now do half as much on an electric motor, and it runs a little hotter. Its launches and its grip in the rain are untouched.'],
        ['🏎', 'An open cockpit you can see into', 'The roadster’s cockpit is cut into the body now, with the seats, dash and tunnel sitting down inside it, instead of a black tray laid on the deck with the furniture stood on top. Its windscreen has a real frame, and its mirrors are bolted to the doors — they used to start a few centimetres above the bodywork, in mid-air.'],
        ['🛠', 'Fixes', 'A bot pinned against a barrel stack only counted itself stuck while flat on the throttle, so one feathering it sat there for the rest of the race; it now asks for a reset (but not while it is waiting for a train on purpose). Mirrors on every car start inside the bodywork. The big bonnet scoop is sized to the bonnet it sits on - it ran into a small car’s windscreen. Roof stripes follow the roof instead of floating off the ends of a curved one, the widebody sill meets the body on a narrow car, and flank liveries stop short of the wheel flares. Car select fits eleven cars with every card’s stat bars showing. A sprint or a drag no longer shows a Best lap column of dashes in the results. On a phone the garage title no longer runs under your cash.'],
      ],
    },
    {
