...
(function (G) {
  ...
  // Between races in a session; any time in single-player (sandbox money).
  HS.casinoOpen = function () {
    return this.state.phase === 'intermission' || this.state.phase === 'results' || this.state.phase === 'sandbox';
  };
